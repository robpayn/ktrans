...
public class StreamBuilderNEOInputProcessorXML extends InputProcessorAbstract<StreamBuilderMetaInputXML,StreamSimulatorNEO> {
   ...
   public void execute() throws Exception 
   {
      ...
      else
      {
         ...
         ResourceSoluteOTIS consResourceOTIS = new ResourceSoluteOTIS();
         consResourceOTIS.initialize("cons");
         
         ResourceSolute actResource = new ResourceSolute();
         actResource.initialize("active");
         ResourceSoluteOTIS actResourceOTIS = new ResourceSoluteOTIS();
         consResourceOTIS.initialize("active");

         // Set up the behaviors
         Behavior consBehaviorFlowOTIS = consResource.getBehavior(ResourceSoluteOTIS.BEHAVIOR_STORAGE_CONC);
